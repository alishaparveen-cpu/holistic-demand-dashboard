        ...
        for cat, kw in KEYWORDS.items():
            ...
            for it in items:
                ...
                rec = {'name': title, 'rating': (it.get('rating') or {}).get('value'),
                       ...
                       'category': it.get('category'),                      # PRIMARY Google Maps category of the listing
                       'additional_categories': it.get('additional_categories') or [],  # the rest of its GMB categories
